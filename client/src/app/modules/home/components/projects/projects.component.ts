...
@Component({
  ...
  template: `
    <div class="my-6 font-semibold rounded p-4">
      <div class="">
        <div
          class="text-center text-2xl md:text-3xl text-gray-800 hover:text-blue-700 cursor-pointer"
        >
          Glimpse of few projects
        </div>
      </div>
      <div
        class="my-6 grid grid-cols-2 gap-5"
        style="grid-template-columns: repeat(2, minmax(0, 1fr))"
      >
        <div
          class="border border-gray-400 rounded-lg flex my-4 flex-col space-y-3 flex-wrap"
        ...
        >
          <header>
            ...
            <div class="text-xl text-blue-600 my-4 mx-2">
              {{ project.title }}
            </div>
          </header>
          <main>
          ...
          <footer class="">
            <div
              [routerLink]="['/projects', 'project-details', project._id, project.title, 'view']"
