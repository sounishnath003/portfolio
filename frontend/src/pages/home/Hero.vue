<template>
  <div class="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
    <div class="mb-8 flex justify-center">
      <div class="text-xl">
        Hello! 👋, I'm
        <span class="text-blue-700 dark:text-yellow-400 dark:text-shadow-md font-medium text-2xl">{{ Portfolio.fullname }}.</span>
      </div>
    </div>
    <div class="text-center">
      ...
      <p class="mt-8 font-medium text-pretty" v-html="Portfolio.profileBio"></p>
      <div class="mt-10 flex items-center justify-center gap-x-6">
        <a :href="Portfolio.resumeLink" target="_blank">
          <PrimaryButton text="Download Resume" buttonType="Download" color="blue" />
        </a>
        <a href="#/pages/work-experience" class="text-sm/6 font-semibold text-gray-900 dark:text-white">Interested? Know
