<template>
  <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
    ...
    <div class="text-center">
      <h1 class="text-6xl font-semibold tracking-tight text-balance sm:text-7xl">{{ attributeValue }}</h1>
      <p class="mt-8 font-medium text-pretty text-gray-500 dark:text-gray-200 font-medium">{{ profileBio }}</p>
      <div class="mt-10 flex items-center justify-center gap-x-6">
        <a :href="resumeLink" target="_blank">
          <PrimaryButton text="Download Resume" buttonType="Download" color="blue" />
        </a>
        <a href="#/about" class="text-sm/6 font-semibold text-gray-900 dark:text-white">Interested? Know more <span
